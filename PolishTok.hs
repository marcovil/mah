...
alex_table = listArray (0 :: Int, 257)
  [ 0
  , 1
  , 1
  , 1
...
alex_check = listArray (0 :: Int, 257)
  [ -1
  , 9
  , 10
  , 11
...
alex_action_1 =  \s -> TokenPlus 
alex_action_2 =  \s -> TokenMinus 
alex_action_3 =  \s -> TokenMult 
alex_action_4 =  \s -> TokenDiv 
alex_action_5 =  \s -> TokenInt (read s) 
