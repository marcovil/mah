...
happyExpList = Happy_Data_Array.listArray (0,22) ([16880,7936,61440,1985,31,49648,7943,124,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","Exp","'+'","'-'","'*'","'/'","int","%eof"]
        bit_start = st * 10
        bit_end = (st + 1) * 10
...
action_4 (4) = happyGoto action_10
